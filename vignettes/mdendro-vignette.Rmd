---
title: "mdendro"
subtitle: "Extended Agglomerative Hierarchical Clustering"
author: "Alberto Fernández, Sergio Gómez"
date: "v2.1.0 (2021-09-12)"
bibliography: mdendro-vignette-references.bib
csl: mdendro-vignette-bibstyle.csl
output:
  rmarkdown::html_document:
    theme: cerulean
    highlight: tango
    css: mdendro-vignette-style.css
    toc: true
    toc_depth: 3
    toc_float:
      collapsed: false
vignette: >
  %\VignetteIndexEntry{mdendro}
...
- Installation from CRAN (recommended method):
    ...
    ```
    [RStudio](https://www.rstudio.com/) has a menu entry (Tools $\rightarrow$ Install Packages) for this job.
...
It is interesting to know how the descriptors depend on those parameters. Package [**mdendro**](https://github.com/sergio-gomez/mdendro) provides a specific function for this task, namely `descplot`. For example, using _versatile_ linkage:
